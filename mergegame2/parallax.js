...
let parallaxCoef = 0.0003; // Initial coefficient value
let smoothFactor = 0.3; // smoothFactor
let smoothedHeadPos = { x: 0, y: 0 };

let kalmanFilterX;
let kalmanFilterY;
let kalmanR = 0.01; // Initial R value
let kalmanQ = 0.1;  // Initial Q value
...
export function setupParallaxCameras() {
    ...
    orbitalCamera = new THREE.PerspectiveCamera(30, window.innerWidth / window.innerHeight, 1, 5000);
    ...
    return { orbitalCamera, gameCamera };
}
